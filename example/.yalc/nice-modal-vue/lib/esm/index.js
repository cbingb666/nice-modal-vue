...
const Provider = {
  ...
  render(vue2h) {
    ...
    const children = visibleModalIds
      ...
      .map((modal) => {
        return h$1(NiceModalHoc(modal.comp), {
          props: {
            ...modal,
            ...modal.props,
          },
    ...
    return h$1(
      ...
      [slots, h$1("div", { staticClass: "nice-modal-container" }, children)]
    );
  },
};
...
/** vant popup 适配器 */
const vantPopupAdapter = (modalCtrl) => {
  return {
    props: {
...
/** elementDialog 适配器 */
const elementDialogAdapter = (modalCtrl) => {
  return {
    props: {
...
const elementPlusDialogAdapter = (modalCtrl) => {
  return {
    props: {
...
export { NiceModal as default, elementDialogAdapter, elementPlusDialogAdapter, hide, remove, vantPopupAdapter };
